...
CSRDashboard.prototype.renderDashboard = function () {
    ...
    // Render list and pagination first so UI shows immediately
    this.renderCompanyList();
    this.renderPaginationControls();

    // Defer summary cards and charts
...
CSRDashboard.prototype.applyFilters = function () {
    this.filteredData = this.data; // Apply your filters here
};
...
// New: break heavy summary cards into separate method
CSRDashboard.prototype.updateSummaryCards = function () {
    console.log("Updating summary cards...");
    // Add code for CSR spending, total projects, etc.
};

// New: break heavy chart drawing into separate method
CSRDashboard.prototype.updateCharts = function () {
    console.log("Updating charts...");
    // Add code for updating charts
};
